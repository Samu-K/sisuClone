...
/**
 * An autocomplete box with typing.
 */
public class AutoCompleteComboBox {
  ...
  */
  ...
  public static <T> ComboBox<HideableItem<T>>
    ...
    FilteredList<HideableItem<T>> filteredHideableItems = new FilteredList<>(
        hideableHideableItems, t -> !t.isHidden()
    );
    ...
    ComboBoxListViewSkin<HideableItem<T>> comboBoxListViewSkin;
    comboBoxListViewSkin = new ComboBoxListViewSkin<HideableItem<T>>(comboBox);
